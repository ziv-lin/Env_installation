...
export PATH=$PATH:~/App/sublime_text_3/:"/home/ziv/Downloads/Livox Viewer For Linux Ubuntu16.04_x64 0.5.0/"
...
alias livox='roslaunch display_lidar_points livox_nodis.launch bd_list:="0TFDFCE00504141&0TFDFCE00504071&0TFDG1H006L6P81C"'
...
alias cd_lr='cd /home/ziv/Desktop/learning_pcl/'
alias cd_ws='cd /home/ziv/catkin_ws/src/livox_loam'
alias chinese_in='fcitx restart'
alias livox_bag='rosbag record /livox/lidar /image/image /image'
alias loam_hz='rostopic hz /aft_mapped_to_init'
alias cpu_perfromance='sudo cpufreq-set -g performance'
alias chmod_tty='sudo chown ziv /dev/tty*'
alias ss_hky='/opt/cisco/anyconnect/bin/vpn connect vpn2fa.hku.hk'
alias smg='/home/ziv/Downloads/smartgit/bin/smartgit.sh'
## For fast launch
alias loam_loop_simple='roslaunch loam_livox rosbag_loop_simple.launch'
alias pym='pycharm.sh'
# added by Anaconda3 installer
#export PATH="$PATH:/home/ziv/anaconda3/bin"
# add pycharm path
export PATH="/home/ziv/Downloads/pycharm-community-2019.2/bin:$PATH"
...
export PATH=/usr/local/cuda-8.0.82/bin:/home/ziv/opt/cmake-3.14.0-rc4-Linux-x86_64/bin:/usr/local/texlive/2019/bin/x86_64-linux:$PATH
...
source /home/ziv/Desktop/learning_pcl/ros_ws/devel/setup.bash
